...
<head>
  ...
  <!-- Stylesheets -->
  <link rel="stylesheet" href="{{ asset('templates/tema-1/css/style.css') }}" />
...
<body>
  <audio id="music" loop>
    <source src="{{ asset('templates/tema-1/music/beautiful_white.mp3') }}" type="audio/mpeg" />
  </audio>
  ...
  <div id="display-invitation" style="display: none">
        ...
        <ul class="list-items">
          <li class="item active">
            <a class="link" href="#beranda">
              <div>
                <img src="{{ asset('templates/tema-1/images/icon/beranda.png') }}" id="img-beranda"
                  class="hidden img-default" />
                <img src="{{ asset('templates/tema-1/images/icon/beranda_gold.png') }}" id="img-beranda_gold"
                  class="img-active" />
              </div>
              <div class="menu-name">
                <span>Beranda</span>
          ...
          <li class="item">
            <a class="link" href="#mempelai">
              <div>
                <img src="{{ asset('templates/tema-1/images/icon/mempelai.png') }}" id="img-mempelai"
                  class="img-default" />
                <img src="{{ asset('templates/tema-1/images/icon/mempelai_gold.png') }}" id="img-mempelai_gold"
          ...
          <li class="item">
            <a class="link" href="#acara">
              <div>
                <img src="{{ asset('templates/tema-1/images/icon/acara.png') }}" id="img-acara"
                  class="img-default" />
                <img src="{{ asset('templates/tema-1/images/icon/acara_gold.png') }}" id="img-acara_gold"
                  class="hidden img-active" />
              </div>
              <div class="menu-name">
                <span>Acara</span>
          ...
          <li class="item">
            <a class="link" href="#lokasi">
              <div>
                <img src="{{ asset('templates/tema-1/images/icon/lokasi.png') }}" id="img-lokasi"
                  class="img-default" />
                <img src="{{ asset('templates/tema-1/images/icon/lokasi_gold.png') }}" id="img-lokasi_gold"
                  class="hidden img-active" />
              </div>
              <div class="menu-name">
                <span>Lokasi</span>
          ...
          <li class="item">
            <a class="link" href="#galeri">
              <div>
                <img src="{{ asset('templates/tema-1/images/icon/galeri.png') }}" id="img-galeri"
                  class="img-default" />
                <img src="{{ asset('templates/tema-1/images/icon/galeri_gold.png') }}" id="img-galeri_gold"
                  class="hidden img-active" />
              </div>
              <div class="menu-name">
                <span>Galeri</span>
          ...
          <li class="item">
            <a class="link" href="#kisah">
              <div>
                <img src="{{ asset('templates/tema-1/images/icon/kisah.png') }}" id="img-kisah"
                  class="img-default" />
                <img src="{{ asset('templates/tema-1/images/icon/kisah_gold.png') }}" id="img-kisah_gold"
                  class="hidden img-active" />
              </div>
              <div class="menu-name">
                <span>Kisah</span>
          ...
          <li class="item">
            <a class="link" href="#hadiah">
              <div>
                <img src="{{ asset('templates/tema-1/images/icon/hadiah.png') }}" id="img-hadiah"
                  class="img-default" />
                <img src="{{ asset('templates/tema-1/images/icon/hadiah_gold.png') }}" id="img-hadiah_gold"
                  class="hidden img-active" />
              </div>
              <div class="menu-name">
                <span>Hadiah</span>
          ...
          <li class="item">
            <a class="link" href="#ucapan">
              <div>
                <img src="{{ asset('templates/tema-1/images/icon/ucapan.png') }}" id="img-ucapan"
                  class="img-default" />
                <img src="{{ asset('templates/tema-1/images/icon/ucapan_gold.png') }}" id="img-ucapan_gold"
                  class="hidden img-active" />
              </div>
              <div class="menu-name">
                <span>Ucapan</span>
    ...
    <div class="music-button">
      <img src="{{ asset('templates/tema-1/images/icon/pause.png') }}" width="20" height="20"
        class="pause-button" />
      <img src="{{ asset('templates/tema-1/images/icon/play.png') }}" width="20" height="20"
    ...
    <div class="section-bg1" id="mempelai">
      <div class="container">
          ...
          <div class="col section-bridal-left">
            <div class="vstack">
              <div class="illustration-bridal-left">
                <center>
                  <img src="{{ asset($invitation->groom_photo) }}" class="bridal_photo" alt="groom" />
                </center>
              </div>
          ...
          <div class="col section-bridal-right">
            <div class="vstack">
              <div class="illustration-bridal-right">
                <center>
                  <img src="{{ asset($invitation->bride_photo) }}" class="bridal_photo" alt="bride" />
                </center>
              </div>
              <div class="text-gold dancing-text heading-text-small mt-4" style="text-align: center">
    ...
    <div class="section-bg1" id="acara">
      <div class="container">
        ...
        <div class="d-flex justify-content-center mb-2">
          <div>
            <img src="{{ asset('templates/tema-1/images/icon/calendar.png') }}" class="mr-2" alt="" />
            <span class="align-middle">{{ $invitation->date->format('l, d F Y') }}</span>
          </div>
        </div>
        <div class="d-flex justify-content-center mb-2">
          <div>
            <img src="{{ asset('templates/tema-1/images/icon/clock.png') }}" class="mr-2" alt="" />
            <span class="align-middle">{{ $invitation->time }}</span>
          </div>
        </div>
        <div class="d-flex justify-content-center mb-2">
          <div>
            <img src="{{ asset('templates/tema-1/images/icon/building.png') }}" class="mr-2" alt="" />
    ...
    <div class="section-bg1" id="countdown">
      <div class="container">
        <div class="d-flex justify-content-center text-gold heading-text-lg dancing-text">
          Countdown
        </div>
    ...
    <div class="section-bg1" id="lokasi">
      <div class="container">
      ...
      <div class="container">
          ...
          <div class="container-galeri d-flex justify-content-center">
            <div class="row gallery">
              <div class="col-sm-6 col-md-4 col-lg-3">
                <a href="{{ asset('templates/tema-1/images/galeri/galeri_1.png') }}">
                  <img class="img-fluid" src="{{ asset('templates/tema-1/images/galeri/galeri_1.png') }}" />
                </a>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-3">
                <a href="{{ asset('templates/tema-1/images/galeri/galeri_2.png') }}">
                  <img class="img-fluid" src="{{ asset('templates/tema-1/images/galeri/galeri_2.png') }}" />
                </a>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-3">
                <a href="{{ asset('templates/tema-1/images/galeri/galeri_3.png') }}">
                  <img class="img-fluid" src="{{ asset('templates/tema-1/images/galeri/galeri_3.png') }}" />
                </a>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-3">
                <a href="{{ asset('templates/tema-1/images/galeri/galeri_4.png') }}">
                  <img class="img-fluid" src="{{ asset('templates/tema-1/images/galeri/galeri_4.png') }}" />
                </a>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-3">
                <a href="{{ asset('templates/tema-1/images/galeri/galeri_5.png') }}">
                  <img class="img-fluid" src="{{ asset('templates/tema-1/images/galeri/galeri_5.png') }}" />
                </a>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-3">
                <a href="{{ asset('templates/tema-1/images/galeri/galeri_6.png') }}">
                  <img class="img-fluid" src="{{ asset('templates/tema-1/images/galeri/galeri_6.png') }}" />
                </a>
              </div>
              <div class="col-sm-6 col-md-4 col-lg-3">
                <a href="{{ asset('templates/tema-1/images/galeri/galeri_1.png') }}">
        ...
        <div class="d-flex justify-content-center space-bottom">
          <div class="container-video d-flex justify-content-center">
            <iframe class="frame-video" src="{{ $invitation->video }}" title="YouTube video player" frameborder="0"
            ...
            <div class="row">
              <div class="col-12 col-sm-3">
                <div class="d-flex flex-column justify-content-center align-items-center">
                  <img src="{{ asset('templates/tema-1/images/galeri/1.png') }}" alt=""
              ...
              <div class="col-12 col-sm-3">
                <div class="d-flex flex-column justify-content-center align-items-center">
                  <img src="{{ asset('templates/tema-1/images/galeri/2.png') }}" alt=""
                    style="width: 100%; aspect-ratio: 1/1; object-fit: cover" />
                  <center>
                    <div class="vl"></div>
                  </center>
              ...
              <div class="col-12 col-sm-3">
                <div class="d-flex flex-column justify-content-center align-items-center">
                  <img src="{{ asset('templates/tema-1/images/galeri/3.png') }}" alt=""
                    style="width: 100%; aspect-ratio: 1/1; object-fit: cover" />
                </div>
              </div>
              <div class="col-12 col-sm-9 d-flex flex-column justify-content-center align-items-start">
              ...
              <div class="row row-gift g-5">
                <div class="col-md-4 col-gift">
                  <div class="card-gift d-flex flex-column">
                    <div class="d-flex justify-content-center">
                      <img src="{{ asset('templates/tema-1/images/gift/vector.png') }}" class="image-gift"
                        alt="" />
                    </div>
                    ...
                    <div class="d-flex justify-content-center text-md text-gold mt-auto"
                      ...
                      <img src="{{ asset('templates/tema-1/images/icon/icon_copy.png') }}" class="icon-text" />
                      Salin
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-gift">
                  <div class="card-gift d-flex flex-column">
                    <div class="d-flex justify-content-center">
                      <img src="{{ asset('templates/tema-1/images/gift/mandiri.png') }}" class="image-gift"
                        style="width: 80%" alt="" />
                    </div>
                    <div class="d-flex justify-content-center text-md mb-4">
                      Hari-H
                ...
                <div class="col-md-4 col-gift">
                  <div class="card-gift d-flex flex-column">
                    <div class="d-flex justify-content-center">
                      <img src="{{ asset('templates/tema-1/images/gift/bni.png') }}" class="image-gift"
                        style="width: 80%" alt="" />
                    </div>
                    <div class="d-flex justify-content-center text-md mb-4">
                      Hari-H
                  ...
                  <div class="row">
                    <div class="col-md-12 mb-4">
                      ...
                      <input type="text" class="form-control form-control-lg form-disabled"
                        placeholder="{{ $recipient }}" disabled />
                    </div>
                    <div class="col-md-12 mb-4">
    ...
    <div class="section-footer" id="ucapan">
      <div class="d-flex justify-content-center">
        <img src="{{ asset('templates/tema-1/images/background/footer-6.svg') }}" alt="" />
      </div>
      <div class="d-flex justify-content-center">
        Copyright &copy;
        <script>
