        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <input type="text" class="form-control @error('bride_parent_name') is-invalid @enderror"
              id="bride_parent_name" name="bride_parent_name" value="{{ old('bride_parent_name') }}" required>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control @error('groom_parent_name') is-invalid @enderror"
              id="groom_parent_name" name="groom_parent_name" value="{{ old('groom_parent_name') }}" required>
