...
@section('content')
  <div class="container">
    <div class="text-center mb-4">
      <h1 class="fs-1 fw-bold text-center">Checkout Undangan</h1>
      <p>
        Isi formulir di bawah untuk memesan undangan, dan temukan solusi undangan digital terbaik untuk pernikahan Anda.
      </p>
    </div>
    ...
    <div class="row justify-content-center">
      <form class="col-md-8 d-flex flex-column gap-3" action="{{ route('user.invitations.store') }}" method="POST"
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <input type="text" class="form-control @error('bride_name') is-invalid @enderror" id="bride_name"
              name="bride_name" value="{{ old('bride_name') }}" required>
            @error('bride_name')
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control @error('groom_name') is-invalid @enderror" id="groom_name"
              name="groom_name" value="{{ old('groom_name') }}" required>
            @error('groom_name')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <input type="text" class="form-control @error('bride_fullname') is-invalid @enderror" id="bride_fullname"
              name="bride_fullname" value="{{ old('bride_fullname') }}" required>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control @error('groom_fullname') is-invalid @enderror" id="groom_fullname"
              name="groom_fullname" value="{{ old('groom_fullname') }}" required>
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            <label for="bride_parent" class="form-label">Bride Parent</label>
            <input type="text" class="form-control @error('bride_parent') is-invalid @enderror" id="bride_parent"
              name="bride_parent" value="{{ old('bride_parent') }}" required>
            @error('bride_parent')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="col-md-6">
            <label for="groom_parent" class="form-label">Groom Parent</label>
            <input type="text" class="form-control @error('groom_parent') is-invalid @enderror" id="groom_parent"
              name="groom_parent" value="{{ old('groom_parent') }}" required>
            @error('groom_parent')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="row mb-3">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control @error('date') is-invalid @enderror" id="date" name="date"
              value="{{ old('date') }}" required min="{{ date('Y-m-d', strtotime('+1 day')) }}">
            @error('date')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
